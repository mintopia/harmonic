...
301 KB each) is 343 MB, 91% of the total, and it grows unbounded. Retired Runs' events
...
2. The DB stores tool-call aggregates only. Per-Run counts of tool calls (by
   ...
   snapshot discipline ADR-0010 chose for usage (push about 1s, persist about 10s and on
