...
import { VerificationCoordinator, EPIC_REFRESH_RESOLVE_TIMEOUT_MS, type EpicVerificationResolutionInput } from './verification-coordinator.js';
...
export class Runner {
  ...
  private mergePolicyDeps(
    ...
    return {
      ...
      runPostMergeCheck: (mergeOid, baseDir) =>
        this.verification.runPostMergeVerification({ task, run, mergeOid, baseDir, signal, record }),
