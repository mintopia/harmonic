...
import { api } from '../api';
import { btnPrimary, field, labelType } from '../ui';
...
export function SecuritySection() {
  ...
  return (
    <div className={`${panel} mb-4`}>
      <h3 className="mb-3 text-headline font-semibold">Security</h3>
      <form onSubmit={submit} className="grid gap-3 sm:grid-cols-2">
        <div>
          <label className={label} htmlFor="security-current-password">Current Password</label>
          <input
        ...
        <div>
          <label className={label} htmlFor="security-new-password">New Password</label>
          <input
